...
@Component({ 
  ...
  styleUrl: './agregar-profesores.component.scss' 
}) 
export class AgregarProfesorComponent implements OnInit { 
    ...
    if(this.idProfesor && this.idProfesor > 0 ){ 
     ...
     this.profesorService.obtenerProfesorPorID(this.idProfesor).subscribe({ 
      next: (temp) => { 
        ...
        this.form.controls['correoProfesor'].setValue(this.formProfesor.correoProfesor); 
  ...
  onSubmit(){ 
    // Asignacion de valores 
            this.formProfesor.nombresProfesor = 
            this.form.get('nombresProfesor')?.value; 
            this.formProfesor.apellidosProfesor = 
            this.form.get('apellidosProfesor')?.value;
            this.formProfesor.correoProfesor = 
            this.form.get('correoProfesor')?.value; 
